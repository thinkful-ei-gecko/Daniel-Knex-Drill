...
//The method 'before' runs... beofre any of the tests(it blocks. )
...
describe('articlesService', () => {
  ...
  //Don't run tests on your production database. Make a test db
  ...
  context(`given 'blogful articles has data`, () => {
    ...
    it(`getAllArticles() resolves all articles `, () => {
